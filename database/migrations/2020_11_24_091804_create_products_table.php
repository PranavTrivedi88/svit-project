...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('products')->insert([
            ...
            'name' => 'Shoes',
            'image' => 'shoes.jpeg',
            'description' => 'Creta-12 sports shoes for men | Latest Stylish Casual sport shoes for men | running shoes for boys | Lace up Lightweight black shoes for running, walking, gym, trekking, hiking & party Running Shoes For Men  (Blue, Orange)',
            'price_per_unit' => 2000,
        ]);
        ...
        DB::table('products')->insert([
            ...
            'name' => 'Mobile',
            'image' => 'mobile.jpeg',
            'description' => 'Take advantage of this realme smartphone’s 64 MP quad camera and click stunning photos. This phone also comes with a bunch of cool filters that’ll make night photography all the more amazing. In addition, this smartphone’s Helio G95 Gaming Processor makes it one powerful performer.',
        ...
        DB::table('products')->insert([
            ...
            'name' => 'Perfume',
            'image' => 'perfume.jpeg',
            'description' => 'MINISO Blooming Eau De Toilette Long Lasting Women Perfumes (Blissful Bouquet) Perfume - 30 ml  (For Women)',
            'price_per_unit' => 800,
        ]);
        ...
        DB::table('products')->insert([
            ...
            'name' => 'Watch',
            'image' => 'watch.jpeg',
            'description' => 'No doubt this watch is superb. Built quality and look beautiful. Dial pretty good and attractive, perfect dial size and strap . There are many companies having similar watches, but I think Fogg is best',
            'price_per_unit' => 1300,
        ]);
